...
const budgetData = {
    cite: { 
        ...
        details: {
            ...
            extras: [
                { desc: "Animation - performance Scala & Kolacny Brothers", price: 17250.00 },
                { desc: "Animation - performance Salt & Pepper (Option)", price: 10680.00 },
                { desc: "Animation caricaturistes (Option)", price: 3562.50 },
                { desc: "Badges", price: 325.00 },
                { desc: "Photobooth", price: 2050.63 },
                { desc: "Décoration (Option)", price: 2027.50 },
                { desc: "Création graphique", price: 400.00 },
                { desc: "Cadeaux yo-yo en bois", price: 1178.75 },
    ...
    bnf: { 
        ...
        details: {
            lieux: [
                ...
                { desc: "Location de salle cérémonie et cocktail BNF (Grand Auditorium & Foyer)", price: 8125.00 },
            ...
            restauration: [
                ...
                { desc: "Cocktail dinatoire - boissons softs", price: 1050.00 },
                { desc: "Cocktail dînatoire - boissons alcoolisées", price: 4818.75 },
                { desc: "Cocktail dînatoire - Mobilier", price: 6612.50 }
            ],
            technique: [
                { desc: "Audiovisuel (Forfait écrans, sonorisation, lumière)", price: 7907.50 },
                { desc: "Topeur", price: 1875.00 },
                { desc: "Agent de sécurité", price: 250.00 },
                { desc: "Hôtes(ses) étudiants et retraités", price: 1750.00 },
            ...
            extras: [
                { desc: "Animation - Julien Lepers", price: 8450.00 },
                { desc: "Animation - Écriture du quiz", price: 1950.00 },
                { desc: "Animation - Matériel du quiz", price: 4862.00 },
                { desc: "Animation - Mentaliste", price: 1950.00 },
                { desc: "Badges", price: 325.00 },
                { desc: "Photobooth", price: 1613.13 },
                { desc: "Décoration", price: 2730.63 },
                { desc: "Création graphique", price: 750.00 },
                { desc: "Intervention Oldyssey", price: 2340.00 },
                { desc: "Cadeaux livres", price: 1027.00 },
                { desc: "Sac kraft", price: 212.50 }
            ],
            accompagnement: [
                { desc: "Temps homme Weever", price: 3600.00 },
    ...
    cirque: { 
        ...
        totalTTC: 149335.58, 
        totalHT: 124507.14, 
        honorairesHT: 11318.83, 
        categories: { 
            lieux: 40191.73, 
            restauration: 23339.39, 
            technique: 27265.72, 
            transports: 7800.00, 
            extras: 10276.48, 
            accompagnement: 4315.00 
        ...
        details: {
            lieux: [
                ...
                { desc: "Nuitée Chambre individuelle Confort", price: 3018.37 },
                { desc: "Nuitée Chambre individuelle Privilège", price: 1352.97 },
                { desc: "Nuitée Chambre double Confort à usage individuel", price: 9019.82 },
            ...
            restauration: [
                ...
                { desc: "Cocktail - champagne (Option)", price: 1694.00 },
            ...
            extras: [
                { desc: "Animation numéro de Cirque", price: 3630.00 },
                    ...
                    <table className="min-w-full divide-y divide-gray-200 text-sm">
                        <thead className="bg-gray-50">
                            <tr>
                                ...
                                <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Cité Internationale</th>
